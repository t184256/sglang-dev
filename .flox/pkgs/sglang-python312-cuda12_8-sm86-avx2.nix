# SGLang 0.5.9 for NVIDIA Ampere (SM86: RTX 3090, A40) — AVX2
# CUDA 12.8 — Requires NVIDIA driver 550+
# Custom PyTorch built from source (SM86 + AVX2)
{ pkgs ? import <nixpkgs> {} }:
let
  ...
  smCapability = "8.6";
  variantName = "sglang-python312-cuda12_8-sm86-avx2";
...
in
  sglang.overrideAttrs (oldAttrs: {
    ...
    meta = oldAttrs.meta // {
      description = "SGLang 0.5.9 for NVIDIA RTX 3090/A40 (SM86) [CUDA 12.8, custom PyTorch AVX2]";
      platforms = [ platform ];
    };
  })
