# SGLang 0.5.9 for NVIDIA Blackwell (SM120: RTX 5090, RTX PRO 6000) — AVX2
# CUDA 12.8 — Requires NVIDIA driver 550+
# Custom PyTorch built from source (SM120 + AVX2)
{ pkgs ? import <nixpkgs> {} }:
let
  ...
  smCapability = "12.0";
  variantName = "sglang-python312-cuda12_8-sm120-avx2";
...
in
  sglang.overrideAttrs (oldAttrs: {
    ...
    meta = oldAttrs.meta // {
      description = "SGLang 0.5.9 for NVIDIA RTX 5090/RTX PRO 6000 (SM120) [CUDA 12.8, custom PyTorch AVX2]";
      platforms = [ platform ];
    };
  })
